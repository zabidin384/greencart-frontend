...
const Cart = () => {
	...
	const getUserAddress = async () => {
		try {
			const { data } = await axios.get("/address/list");
		...
		<div className="flex flex-col md:flex-row mt-16">
			<div className="flex-1 max-w-4xl">
				...
				{cartArray.map((product, index) => (
					<div
						key={index}
						className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr] text-gray-500 items-center text-sm md:text-base font-medium pt-3"
					>
						...
						<p className="text-center">{cartItems[product._id]}</p>
